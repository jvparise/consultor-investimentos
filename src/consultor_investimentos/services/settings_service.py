...
_CLASS_TO_FIELD: dict[AssetClass, str] = {
    ...
    AssetClass.ETF: "target_etf_pct",
    AssetClass.FII_BRICK: "target_fii_brick_pct",
    AssetClass.FII_PAPER: "target_fii_paper_pct",
...
class SettingsService:
    ...
    def get_settings(self) -> SettingsDTO:
        ...
        return SettingsDTO(
            ...
            target_etf_pct=orm.target_etf_pct,
            target_fii_brick_pct=orm.target_fii_brick_pct,
            target_fii_paper_pct=orm.target_fii_paper_pct,
